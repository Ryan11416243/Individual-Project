...
def extract_features_single(freqs, mags, ref_mags, file_id, unit_id):
    ...
    # ---------------------------------------------------------
    # Windowed Maxima Peak Extraction
    # ---------------------------------------------------------
    # Define the 5 static frequency windows
    windows = [
        (10, 10000),       # Window 1: Deep Core/Inductive (Captures HV LF)
        (10000, 100000),   # Window 2: Main HV Resonances (MF)
        (100000, 300000),  # Window 3: Main LV Resonances (HF 1)
        (300000, 600000),  # Window 4: Capacitive Tail (HF 2)
        (600000, 1000000)  # Window 5: Extreme Frequencies (HF 3)
    ]
